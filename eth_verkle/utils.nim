...
func bitsToHex*(b: byte): char =
  ...
  of 15:
    ...
    raise newException(ValueError, "Given byte must be uint4 (0-15)")
...
func hexToBits*(c: char): byte =
  ...
  of 'f', 'F':
    ...
    raise newException(ValueError, "Character must be hexadecimal (a-f | A-F | 0-9)")
...
func firstMatchAt*[T](
    s: seq[T], pred: proc(x: T): bool {.closure.}
